...
namespace GUIBase
{
    public delegate bool IsSelectablePriceArea(PriceArea rs);


    public class DGVColumnHeaderPriceArea : DataGridViewColumnHeaderCell
    {
        public IsSelectablePriceArea IsSelectabeFunction { get; set; }
        ...
        protected override void OnMouseClick(DataGridViewCellMouseEventArgs e)
        {
            ...
            if (rec.Contains(e.Location))
            {
                ...
                if (e.ColumnIndex == SelectedColumnIndex)
                {
                    ...
                    {
                        if (IsSelectabeFunction(this.DataGridView.Rows[i].DataBoundItem as PriceArea))
